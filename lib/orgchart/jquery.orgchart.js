(function($) {
    ...
    function OrgChart($container, opts){
        ...
        for(var i in nodes){
            ...
            else if (nodes[nodes[i].data.parent]){
    ...
    function Node(data){
        ...
        this.render = function(opts){
            ...
            mainTable += "<tr><td colspan='"+nodeColspan+"'>"+ (opts.render !== null ? opts.render(self.data.id) : self.formatNode(opts))+"</td></tr>";
